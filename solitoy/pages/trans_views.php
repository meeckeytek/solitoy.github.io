            ...
            <div class="card-body">
              <div class="form-group row text-left mb-0">
                ...
                <h5>
                 <div>
                  <div>
                  <img src="../img/logo.png" alt="" style="width:90px;height:90px;"></div>
                  <div style="margin-top: -107px;margin-left: 113px;">
                   <strong style="font-size:53px;">SOLITOY</strong><br/><b> NIGERIA ENTERPRISES</b>
                   </div> <br>
                   <marquee behavior="alternate" direction="">welcome sir</marquee>
              </div>
                </div>
